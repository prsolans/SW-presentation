...
$(document).ready(function () {
    ...
    function onWindowResize() {
        ...
        if (windowWidth > 480) {
            $('.contact-social-links').each(function () {
                ...
                $('.social.outside-left').attr('src', 'CMSTemplates/Mergeworld/Content/images/icon/facebook-black.png');
    ...
    menuIcon.on('click', function () {
        if (menu.hasClass('open')) {
            menuIcon.attr('src', 'CMSTemplates/Mergeworld/Content/images/menu.png');
            ...
            menu.animate({opacity: 1}, 0, function(){
                ...
                menuIcon.css('background-color', '#292929').attr('src', 'CMSTemplates/Mergeworld/Content/images/menu-close.png');//.delay(350).css('background-color', '#292929').attr('src', 'CMSTemplates/Mergeworld/Content/images/menu-close.png');
            });
        }
    });
    ...
    $(window).resize(function () {
        if ($(document).width() >= '1024') {
            logo.show();
            menuIcon.attr('src', 'CMSTemplates/Mergeworld/Content/images/menu.png').hide();
